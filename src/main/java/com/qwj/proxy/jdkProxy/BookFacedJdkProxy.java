 ...
 * FileName: BookFacedJdkProxy
 * Author:   qianwenjun
 * Date:     2019/3/16 08:49
 * Description:
 */
package com.qwj.proxy.jdkProxy;
 ...
 * @since 1.0.0
 */
public class BookFacedJdkProxy implements InvocationHandler {
    ...
    public static void main(String[] args) {
        BookFacedJdkProxy proxy = new BookFacedJdkProxy();
